<aura:application extends="force:slds" template="c:BearAppTemplate">
        <aura:attribute name="listView" type="String" default="visible"/>
        <aura:attribute name="markersTitle" type="String" default="All Bears Worldwide" />
	...
	<lightning:layout class="slds-p-around_medium" multipleRows="true">
		...
		<lightning:layoutItem size="12" smallDeviceSize="12" mediumDeviceSize="9">
            ...
            <c:bearsWorldwide listView="{!v.listView}" markersTitle="{!v.markersTitle}" />
		</lightning:layoutItem>
	</lightning:layout>
